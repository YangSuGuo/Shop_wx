<template>
	<view style="overflow-y: auto;">
		<!-- 轮播图 -->
	<u-swiper name="image" border-radius='1' :duration='duration' :interval='interval' :height="height" :list="swipperList"></u-swiper>
		<!-- 标题 -->
		<view class="header">
	 ...
	 <view class="info-fa">
		  ...
		  <view class="info">
			  <u-steps active-color="#FF7660" style="width: 100%;" mode="number" :list="numlist" :current="4" ></u-steps>
		  </view>
		  <view class="info-fa">
		  		  <view class="fa-left">  </view>
		  		  <view class="goodsInfo">
...
<!-- 立刻交易 -->
 <u-popup :mask-close-able="false" border-radius="15" width="85%" height="200px" v-model="show" mode="center">
		  ...
		  <view class="conBtn"> 
			  <u-button @click="cancel" style="margin-right: 15px;" type="info">取消订单</u-button>
			  <u-button @click="confirm" style="margin-left: 15px;" :custom-style="customStyle" type="error">确认订单</u-button>
		  </view>
	  </u-popup>
...
// })
// const reportCancel =()=>{
// 	reportCancel.value = false;
// }
// const reportConfirm =()=>{
// 	reportConfirm.value = false;
// }
